...
public class AisRequestService {
    ...
    public AISPendingRequest buildAisPendingRequest(String responseId, UserData userData) {
        ...
        com.swisscom.ais.itext7.client.rest.model.pendingreq.OptionalInputs optionalInputs =
            new com.swisscom.ais.itext7.client.rest.model.pendingreq.OptionalInputs();
